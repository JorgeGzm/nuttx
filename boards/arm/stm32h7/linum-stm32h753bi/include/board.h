...
#define STM32_APB1_TIM12_CLKIN  (1*STM32_PCLK1_FREQUENCY)
#define STM32_APB1_TIM13_CLKIN  (1*STM32_PCLK1_FREQUENCY)
#define STM32_APB1_TIM14_CLKIN  (1*STM32_PCLK1_FREQUENCY)
...
/* PWM - Buzzer */
#define GPIO_TIM4_CH2OUT   (GPIO_TIM4_CH2OUT_1)   /* PWM4 - PB7 */
